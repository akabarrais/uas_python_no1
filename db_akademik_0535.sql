...
--
-- Host: 127.0.0.1
-- Generation Time: 24 Jan 2022 pada 20.11
...
--
-- Database: `db_akademik_0535`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_students_0535`
--

CREATE TABLE `tbl_students_0535` (
  `id` int(10) NOT NULL,
...
--
-- Dumping data untuk tabel `tbl_students_0535`
--

INSERT INTO `tbl_students_0535` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0535`
--
ALTER TABLE `tbl_students_0535`
  ADD PRIMARY KEY (`id`);
COMMIT;
